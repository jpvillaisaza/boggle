...
var _jpvillaisaza$boggle$Dice$roll = F2(
	function ($default, dice) {
		var helper = function (i) {
			var _p0 = A2(_elm_community$list_extra$List_Extra$getAt, i, dice.sides);
			if (_p0.ctor === 'Nothing') {
				return $default;
			} else {
				return _p0._0;
		...
		var n = _elm_lang$core$List$length(dice.sides);
		return A2(
			_elm_lang$core$Random$map,
			helper,
			A2(_elm_lang$core$Random$int, 0, n - 1));
	});
var _jpvillaisaza$boggle$Dice$gene = F2(
	function ($default, dice) {
		var helper = function (list) {
			return _elm_community$random_extra$Random_Extra$combine(
				A2(
					_elm_lang$core$List$map,
					_jpvillaisaza$boggle$Dice$roll($default),
					list));
		};
		return A2(
			_elm_lang$core$Random$andThen,
			helper,
			_elm_community$random_extra$Random_List$shuffle(dice));
	});
var _jpvillaisaza$boggle$Dice$Dice = function (a) {
	return {sides: a};
};

var _jpvillaisaza$boggle$Boggle$viewTime = function (time) {
	var seconds = A3(
...
var _jpvillaisaza$boggle$Boggle$viewLettersTableCell = function (letter) {
	return A2(
...
var _jpvillaisaza$boggle$Boggle$viewLettersTableRow = function (letters) {
	return A2(
		_elm_lang$html$Html$tr,
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _jpvillaisaza$boggle$Boggle$viewLettersTableCell, letters));
};
var _jpvillaisaza$boggle$Boggle$viewLettersTableBody = function (letters) {
	return A2(
		_elm_lang$html$Html$tbody,
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _jpvillaisaza$boggle$Boggle$viewLettersTableRow, letters));
};
var _jpvillaisaza$boggle$Boggle$viewLettersTable = function (letters) {
	return A2(
		_elm_lang$html$Html$table,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _jpvillaisaza$boggle$Boggle$viewLettersTableBody(letters),
			_1: {ctor: '[]'}
		});
};
var _jpvillaisaza$boggle$Boggle$viewLetters = F2(
	function (length, letters) {
		return _jpvillaisaza$boggle$Boggle$viewLettersTable(
			A2(_elm_community$list_extra$List_Extra$groupsOf, length, letters));
	});
var _jpvillaisaza$boggle$Boggle$spanishLetterDice = {
	ctor: '::',
	_0: _jpvillaisaza$boggle$Dice$Dice(
		{
			ctor: '::',
...
var _jpvillaisaza$boggle$Boggle$internationalLetterDice = {
	ctor: '::',
	_0: _jpvillaisaza$boggle$Dice$Dice(
		{
			ctor: '::',
...
var _jpvillaisaza$boggle$Boggle$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {dice: a, language: b, length: c, letters: d, state: e, time: f, windowSize: g};
	});
var _jpvillaisaza$boggle$Boggle$Playing = {ctor: 'Playing'};
var _jpvillaisaza$boggle$Boggle$Paused = {ctor: 'Paused'};
var _jpvillaisaza$boggle$Boggle$Over = {ctor: 'Over'};
var _jpvillaisaza$boggle$Boggle$Other = {ctor: 'Other'};
var _jpvillaisaza$boggle$Boggle$Spanish = {ctor: 'Spanish'};
var _jpvillaisaza$boggle$Boggle$English = {ctor: 'English'};
var _jpvillaisaza$boggle$Boggle$UpdateWindowSize = function (a) {
	return {ctor: 'UpdateWindowSize', _0: a};
};
var _jpvillaisaza$boggle$Boggle$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _jpvillaisaza$boggle$Boggle$subscriptions = function (model) {
	var sd = _elm_lang$core$Native_Utils.eq(model.state, _jpvillaisaza$boggle$Boggle$Playing) ? {
		ctor: '::',
		_0: A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _jpvillaisaza$boggle$Boggle$Tick),
		_1: {ctor: '[]'}
	} : {ctor: '[]'};
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _elm_lang$window$Window$resizes(_jpvillaisaza$boggle$Boggle$UpdateWindowSize),
			_1: sd
		});
};
var _jpvillaisaza$boggle$Boggle$SwitchLanguageTo = function (a) {
	return {ctor: 'SwitchLanguageTo', _0: a};
};
var _jpvillaisaza$boggle$Boggle$viewLanguage = function (language) {
	var radio = F3(
		function (lang, value, msg) {
			return A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$name('language'),
								_1: {
									ctor: '::',
									...
									_1: {
										...
										_0: _elm_lang$html$Html_Attributes$checked(
											_elm_lang$core$Native_Utils.eq(lang, language)),
										_1: {ctor: '[]'}
									}
								}
							}
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A3(
				radio,
				_jpvillaisaza$boggle$Boggle$English,
				_elm_lang$core$Basics$toString(_jpvillaisaza$boggle$Boggle$English),
				_jpvillaisaza$boggle$Boggle$SwitchLanguageTo(_jpvillaisaza$boggle$Boggle$English)),
			_1: {
				ctor: '::',
				_0: A3(
					radio,
					_jpvillaisaza$boggle$Boggle$Spanish,
					_elm_lang$core$Basics$toString(_jpvillaisaza$boggle$Boggle$Spanish),
					_jpvillaisaza$boggle$Boggle$SwitchLanguageTo(_jpvillaisaza$boggle$Boggle$Spanish)),
				_1: {ctor: '[]'}
			}
		});
};
var _jpvillaisaza$boggle$Boggle$Shake = {ctor: 'Shake'};
var _jpvillaisaza$boggle$Boggle$Pause = {ctor: 'Pause'};
var _jpvillaisaza$boggle$Boggle$viewButtons = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$button,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_jpvillaisaza$boggle$Boggle$Shake),
						_1: {ctor: '[]'}
					}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Shake'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('pause'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_jpvillaisaza$boggle$Boggle$Pause),
							_1: {ctor: '[]'}
						}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_elm_lang$core$Native_Utils.eq(model.state, _jpvillaisaza$boggle$Boggle$Other) ? 'Unpause' : 'Pause'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _jpvillaisaza$boggle$Boggle$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _jpvillaisaza$boggle$Boggle$viewTime(model.time),
					_1: {
						ctor: '::',
						_0: _jpvillaisaza$boggle$Boggle$viewButtons(model),
						_1: {
							ctor: '::',
							_0: A2(_jpvillaisaza$boggle$Boggle$viewLetters, model.length, model.letters),
							_1: {ctor: '[]'}
						}
					}
				}),
...
var _jpvillaisaza$boggle$Boggle$New = function (a) {
	return {ctor: 'New', _0: a};
};
var _jpvillaisaza$boggle$Boggle$init = function () {
	var model = {
		dice: _jpvillaisaza$boggle$Boggle$spanishLetterDice,
		language: _jpvillaisaza$boggle$Boggle$Spanish,
		length: 5,
		letters: A2(
			_elm_lang$core$List$repeat,
			25,
			_elm_lang$core$Native_Utils.chr(' ')),
		state: _jpvillaisaza$boggle$Boggle$Other,
		time: 3 * _elm_lang$core$Time$minute,
	...
	return {
		...
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
				_0: A2(_elm_lang$core$Task$perform, _jpvillaisaza$boggle$Boggle$UpdateWindowSize, _elm_lang$window$Window$size),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$core$Random$generate,
						_jpvillaisaza$boggle$Boggle$New,
						A2(
							_jpvillaisaza$boggle$Dice$gene,
							_elm_lang$core$Native_Utils.chr('A'),
							model.dice)),
					_1: {ctor: '[]'}
				}
...
var _jpvillaisaza$boggle$Boggle$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'New':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{letters: _p0._0, state: _jpvillaisaza$boggle$Boggle$Playing, time: 3 * _elm_lang$core$Time$minute}),
			...
			case 'Pause':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							state: _elm_lang$core$Native_Utils.eq(model.state, _jpvillaisaza$boggle$Boggle$Other) ? _jpvillaisaza$boggle$Boggle$Playing : _jpvillaisaza$boggle$Boggle$Other
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Shake':
			...
			case 'Tick':
				var t = model.time - _elm_lang$core$Time$second;
				return _elm_lang$core$Native_Utils.eq(t, 0) ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{time: t, state: _jpvillaisaza$boggle$Boggle$Other}),
					_1: _elm_lang$core$Platform_Cmd$none
				} : {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
...
var _jpvillaisaza$boggle$Boggle$main = _elm_lang$html$Html$program(
	{init: _jpvillaisaza$boggle$Boggle$init, view: _jpvillaisaza$boggle$Boggle$view, update: _jpvillaisaza$boggle$Boggle$update, subscriptions: _jpvillaisaza$boggle$Boggle$subscriptions})();

var Elm = {};
Elm['Boggle'] = Elm['Boggle'] || {};
if (typeof _jpvillaisaza$boggle$Boggle$main !== 'undefined') {
    _jpvillaisaza$boggle$Boggle$main(Elm['Boggle'], 'Boggle', undefined);
}
